...
//     .controller('H1MonthController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){        
...
// angular.module('myApp')
//     .controller('H2MonthController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
...
// angular.module('myApp')
//     .controller('H3MonthController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
...
// angular.module('myApp')
//     .controller('H1WeekController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
//         //Habit 1 LAST WEEK
...
// angular.module('myApp')
//     .controller('H2WeekController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
...
// angular.module('myApp')
//     .controller('H3WeekController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
//         //Habit 3 LAST WEEK
...
// angular.module('myApp')
//     .controller('H1AllTimeController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){
//         $scope.FinalH1N = 0
//         $scope.FinalH1Y = 0
//         $scope.FinalH10 = 0
...
// angular.module('myApp')
//     .controller('H2AllTimeController', ['$scope', '$http', 'userInfo', function($scope, $http, $userInfo){  
//         //Habit 2 ALL TIME
//         $scope.FinalH2N = 0
//         $scope.FinalH2Y = 0
//         $scope.FinalH20 = 0
